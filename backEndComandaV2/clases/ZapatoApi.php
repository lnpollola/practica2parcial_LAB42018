 ...
 public static function AltaWebSegundoParcial($request, $response, $args) 
{
    ...
    $codigozapato= $ArrayDeParametros['codigozapato'];
    $nombre= $ArrayDeParametros['nombre'];
    $fingreso = $ArrayDeParametros['fingreso'];
    $localventa= $ArrayDeParametros['localventa'];
    $precio= $ArrayDeParametros['precio'];
    $sexozapato = $ArrayDeParametros['sexozapato'];
    
    $zapato = new Zapato();

     $zapato->codigozapato = $codigozapato;
    $zapato->nombre = $nombre;
    $zapato->fingreso = $fingreso;

    $zapato->localVenta = $localventa;
    $zapato->precio = $precio;
    $zapato->sexoZapato = $sexozapato;
